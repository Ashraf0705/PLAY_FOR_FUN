...
export default function WeeklyLeaderboardPage() {
    ...
    const processedLeaderboard = leaderboard.map((player, index) => {
                ...
                {!isLoadingData && !error && processedLeaderboard.length > 0 && (
                    <div className="overflow-x-auto"> {/* Added for responsiveness on small screens */}
                        <table className="leaderboard-table">
                            <thead>
                                <tr>
                                    <th className="w-1/6">Rank</th> {/* Added w-1/6 for rank */}
                                    <th>Player</th>
                                    <th className="w-1/4 text-right">Weekly Points</th> {/* Added w-1/4 for points */}
                                </tr>
                            </thead>
                            <tbody>
